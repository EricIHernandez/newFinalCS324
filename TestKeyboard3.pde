...
void setup() {
  ...
  keyboard.add(wk);
  for(int i = 0;i<2;i++){
    mk = new MiddleKey(600*i+150,450,2+i*13,color(200,200,300));
    keyboard.add(mk);
    mk = new MiddleKey(600*i+250,450,4+i*13,color(200,300,200));
    keyboard.add(mk);
    mk = new MiddleKey(600*i+400,450,7+i*13,color(200,200,300));
    keyboard.add(mk);
    mk = new MiddleKey(600*i+500,450,9+i*13,color(200,300,200));
    keyboard.add(mk);
    mk = new MiddleKey(600*i+600,450,11+i*13,color(200,200,300));
    keyboard.add(mk);
  }
